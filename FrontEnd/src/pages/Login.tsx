      ...
      <div className="auth-split-grid">
        <div className="auth-side-brand">
          <div className="auth-side-brand-inner">
            ...
            <h2 className="auth-side-title">Hubungkan Bisnis Bahari Anda di SEAPEDIA</h2>
            <p className="auth-side-desc">
              Satu platform maritime commerce terpadu yang memfasilitasi transaksi aman, transparan, dan terpercaya untuk seluruh pelaku usaha kelautan Indonesia.
            </p>
        ...
        <div className="auth-side-form">
          <div className="auth-form-inner">
            <header className="auth-form-header">
              ...
              <p className="auth-form-subtitle">Masukkan detail akun Anda untuk mengakses dashboard.</p>
            </header>
            ...
            <footer className="auth-form-footer">
              Belum memiliki akun? <Link to="/register" className="auth-footer-link">Daftar Akun Baru</Link>
            </footer>
          </div>
        </div>
      </div>
